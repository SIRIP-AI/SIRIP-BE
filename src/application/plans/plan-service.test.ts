...
function view(status: PlanView['status']): PlanView {
  return { id: '10', version: 1, status, previousPlanId: '9', reason: 'Current', createdAt: context.now, approvedAt: null, completedAt: null, batches: [{ id: '7', code: 'B-7' }], trigger: null, steps: [] };
}
