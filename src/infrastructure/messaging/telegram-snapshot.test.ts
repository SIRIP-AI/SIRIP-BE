...
test('operational snapshot contains scoped current facts and bounds alert text', async () => {
  ...
  const plans = { list: async () => ({ updatedAt: '', proposedPlans: [], history: [{ secret: 'excluded' }], activePlans: [{ id: '20', version: 2, status: 'ACTIVE', previousPlanId: null, reason: 'excluded reason', deadline: null, createdAt: '', approvedAt: null, completedAt: null, batches: [{ id: '1', code: 'B-01' }], trigger: null, steps: [{ id: '4', sequence: 1, actionType: 'LOAD', scheduledAt: '2026-08-22T10:00:00.000Z', status: 'UPCOMING', completedAt: null, notes: null, batch: { id: '1', code: 'B-01' }, resource: { type: 'VEHICLE', id: '1', name: 'TR-01' } }] }] }) } as unknown as PlanService;
